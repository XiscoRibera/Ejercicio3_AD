...
Dado que la distribución conjunta de $(X_1, X_2, X_3)'$ es normal multivariante, cada variable $X_i$ és normal univariante con media $\mu_i$ y $\sigma_i^2=\sigma_{ii}$. Entonces, 
$$X_1 \sim N(0.7, \sqrt2), \quad X_2 \sim N(0.8, \sqrt2), \quad X_3 \sim N(0.9, 1)$$
Sabemos que una combinación lineal de las tres variables será normal univariante, así que $W=\frac13X_1 + \frac13X_2 + \frac13X_3$ será normal univariante.
...
- Para $\Sigma_{11}$, necesitamos la matriz de covarianzas de $X=(X_1, X_2)$, que tiene una distribución normal bivariante con vector de medias$(0.7, 0.8)'$ y varianza 
$$\begin{pmatrix}
2 & -1\\
-1 & 2
\end{pmatrix}.$$
...
- En el caso de $W$, solamente sabemos que es el promedio de las tres variables iniciales.
$$Var(W)=Var\left(\frac{X_1+X_2+X_3}{3}\right)=\frac19Var(X_1+X_2+X_3) = \frac19\left(Var(X_1+X_2) + Var(X_3) + 2Cov(X_1+X_2, X_3)\right)$$
$$= \frac19\left(Var(X_1) + Var(X_2) + 2Cov(X_1, X_2) + Var(X_3) + 2Cov(X_1, X_3) + 2Cov(X_2, X_3)\right).$$
De la matriz de covarianzas, tenemos que $Cov(X_i, X_3) = 0, i=1,2$, y que $Cov(X_1, X_2) = -1$. También tenemos en la diagonal las varianzas, entonces
...
Para el primer término, sabemos que $Cov(X_1, W) = E(X_1W) - EX_1 \cdot EW$.
$$E\left(X_1\frac{X_1+X_2+X_3}{3}\right)-0.7E\left(\frac{X_1+X_2+X_3}{3}\right)=\frac13E(X_1^2+X_1X_2+X_1X_3)-\frac{0.7}{3}(EX_1+EX_2+EX_3)=$$


$$\frac13\left[E(X_1^2)+E(X_1X_2)+E(X_1X_3)\right]-0.7\frac13(0.7+0.8+0.9)=$$
$$\frac13\left[Var(X_1)+(EX_1)^2+EX_1EX_2 + Cov(X_1,X_2)+EX_1EX_3 + Cov(X_1,X_3)\right]-0.7\cdot0.8=$$
$$\frac13\left[2+0.7^2+0.7\cdot0.8 -1 + 0.7\cdot0.9\right]-0.7\cdot0.8=\frac13\frac{67}{25}-\frac{14}{25}=\frac13.$$


Para el segundo, tenemos $Cov(X_2, W) = E(X_2W) - EX_2 \cdot EW$.

$$E\left(X_2\frac{X_1+X_2+X_3}{3}\right)-0.8E\left(\frac{X_1+X_2+X_3}{3}\right)=\frac13E(X_1X_2+X_2^2+X_2X_3)-\frac{0.8}{3}(EX_1+EX_2+EX_3)=$$
$$\frac13\left[E(X_1X_2)+E(X_2^2)+E(X_2X_3)\right]-0.8\frac13(0.7+0.8+0.9)=$$
$$\frac13\left[EX_1EX_2 + Cov(X_1, X_2) + Var(X_2) + (EX_2)^2 +EX_2EX_3 + Cov(X_2,X_3)\right]-0.8\cdot0.8=$$
$$\frac13\left[0.7\cdot0.8 - 1+ 2 + 0.8^2 + 0.8\cdot0.9\right]-0.8^2=\frac13\frac{73}{25}-\frac{16}{25}=\frac13.$$
